...
import torch
from Repair.models import networks
...
class Decoder(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64,
        ...
        self.annotation_mask = networks.AttentionLayer(512)
        # self.nn_conv = nn.Conv2d(1024,512,kernel_size=3,stride=1,padding=1)
        Decoder_1 = UnetSkipConnectionDBlock(768, ngf * 8, norm_layer=norm_layer, use_dropout=use_dropout,
                                             innermost=True)
    ...
    def forward(self, input_1, input_2, input_3, input_4, input_5, input_6,anno_mask):
        # input_mask_6 = self.annotation_mask(anno_mask,input_6)
        input_mask_6 = torch.cat([input_6,anno_mask],dim=1)
        y_1 = self.Decoder_1(input_mask_6)

...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans: int = 26, num_classes: int = None, depths: list = None,
        ...
        # 第一层
        self.score_dsn1 = nn.Conv2d(192, 64, 3, 1, 1)
        ...
        # 第二层
        self.score_dsn2 = nn.Conv2d(384, 128, 3, 1, 1)
        ...
        # 第三层
        self.score_dsn3 = nn.Conv2d(768, 256, 3, 1, 1)
        ...
        # 第四层
        self.score_dsn4 = nn.Conv2d(1536, 512, 3, 1, 1)
